    ...
    <div>
      ...
      <nav className="w-full flex items-center justify-between px-4 sm:px-6 md:px-8 mx-auto max-w-6xl py-3">
        ...
        <Link href="/" className="flex items-center gap-2" onClick={() => setIsOpen(false)}>
          <Image src="/logo.png" alt="Mayorista" width={36} height={36} priority />
          <span className="hidden sm:block text-sm font-semibold tracking-wide">
            La guaca del reloj — Mayoristas
          </span>
        </Link>

        {/* Desktop: íconos de navegación */}
      ...
      {/* Secciones de categorías — solo desktop */}
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-gray-100">
          <Link href="/" className="flex items-center gap-2" onClick={() => setIsOpen(false)}>
            <Image src="/logo.png" alt="Mayorista" width={28} height={28} />
            <span className="text-sm font-semibold tracking-wide">Mayoristas</span>
          </Link>
          <button
            onClick={() => setIsOpen(false)}
